  ...
  return (
      <main className={styles.main}>
        ...
        <div className={styles.header}>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              <strong>Languages:</strong> Java, Typescript, JavaScript, Python, HTML, CSS
             </li>
             <li className={styles.listItem}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.sentence}>
               On this project, I contributed by creating and developing my dedicated page within the site. 
               I designed the layout and content for the Krish page, ensuring it matched the overall style 
               of the project while reflecting my personal introduction. My work focused on adding clear structure, 
               consistent styling, and smooth integration with the existing navigation so that it blended seamlessly 
